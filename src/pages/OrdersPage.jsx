              ...
              >
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right space-y-2">
                    ...
                    <p className="text-sm text-gray-500">Total: ${order?.totalPrice?.toFixed(2) || 0}</p>
                ...
                <div className="border-t pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {order_items?.length > 0 ? (
                    order_items.map((item) => (
                      ...
                      onClick={() => navigate(`/dish/${item.dish_name}`)}
                    ...
                    >
                      <DishImage dish_name={item.dish_name} width={60} height={60} />
                    
                      <div className="flex-grow space-y-1 text-sm">
                        <p className="font-medium truncate hover:underline">Dish ID: {item.dish_name}</p>
